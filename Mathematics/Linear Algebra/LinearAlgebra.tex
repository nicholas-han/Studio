...
\newtheorem{theorem}{Theorem}[theorem] % a statement that has been proven to be true
\newtheorem{proposition}{Proposition}[theorem] % a less important but nonetheless interesting true statement
...
\newtheorem{lemma}{Lemma}[theorem] % a less important theorem that is helpful in proving other true statements
